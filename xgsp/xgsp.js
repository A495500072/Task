...
function xgkbx(timeout = 0) {
    return new Promise((resolve) => {
        ...
        let url = {
            ...
            body: `{\n  \"polaris_version\" : \"9.9.9\",\n  \"luckycat_version_name\" : \"9.9.9\",\n  \"luckycat_version_code\" : \"999999\",\n  \"act_common\" : {\n    \"act_token\" : \"FJ4bewJhZx6qz1BjWDJSlcNUPvoewzjYpbAYvY2eKFLwArHoUMYXpirkus2b17I41M9g1hx4nJiu6x2szou0nLhsoVznZwE-7lJ4PtUM0m5TFK6yx3gxYCLUDqAbfIhmrEhJwlnKLyKojFBKyHdbB26HnJ4uRig7H73shjlvpQU\",\n    \"settings_version\" : 1,\n    \"static_settings_version\" : 1,\n    \"dynamic_settings_version\" : 1,\n    \"polling_settings_version\" : 0,\n    \"act_base\" : \"YTpTZgVTHa5WngYIiAXFJwwb6GNdf87QP7hoxtDkTnj8I__kMDYlun2n2Kb62MFU6J06PPWCoLVm3fgzoKOQ2hRIIM_KrnGDOi16UqsAszK9YDpkZTNkL0DmLul00NCakcI7iM_TMxRJqfbflgoXRbQq5eN9LqOxXQaEnoSJI7vZop_ZNSF1CZtQzQWpKj0L\",\n    \"act_data\" : \"-X5or1LofFLA94OM9TsszQ\",\n    \"sdk_version\" : \"6.7.0-rc.1\"\n  }\n}`,
        }
        $.post(url, async (err, resp, data) => {
            try {
