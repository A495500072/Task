...
/*//西瓜转圈圈视频
let XGSPzqurl = ($.isNode() ? process.env.XGSPzqurl :  $.getdata('XGSPzqurl')) || '';
let XGSPzqhd = ($.isNode() ? 
process.env.XGSPzqhd :    $.getdata('XGSPzqhd')) || '';
let XGSPzqbody = ($.isNode() ?process.env.XGSPzqbody : $.getdata('XGSPzqbody')) || '';
